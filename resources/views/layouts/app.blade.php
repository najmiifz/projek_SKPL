...
<body class="bg-slate-50">
  ...
  {{-- 
     ...
     Ubah 'min-h-screen' menjadi 'h-screen overflow-hidden'.
     Ini membuat halaman tidak scroll secara keseluruhan, tapi membatasi tinggi sesuai layar.
  --}}
  <div class="flex h-screen overflow-hidden">
    
    @php $u = auth()->user(); @endphp
    
    {{-- Ubah min-h-screen menjadi h-full agar mengikuti tinggi container --}}
    <aside class="w-72 bg-[#0F172A] text-white h-full flex flex-col shadow-2xl transition-all duration-300 relative group z-50">
      ...
      <div class="p-6 border-b border-slate-800/50 flex flex-col gap-4 relative flex-shrink-0">
      ...
      <div class="p-6 border-t border-slate-800/50 bg-slate-800/10 relative flex-shrink-0">
        <div class="flex items-center gap-3">
    ...
    {{-- Ini mengambil sisa lebar dan akan memiliki scrollbar sendiri karena overflow-hidden di induk --}}
    <main class="flex-1 flex flex-col bg-[#F8FAFC] h-full">
      <style>
      ...
      <header class="bg-white/80 backdrop-blur-md border-b border-slate-200 px-8 py-5 flex items-center justify-between sticky top-0 z-40 shadow-sm flex-shrink-0">
      ...
      {{-- overflow-y-auto di sini memastikan HANYA area konten ini yang di-scroll --}}
